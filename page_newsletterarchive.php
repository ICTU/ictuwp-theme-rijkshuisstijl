...
function wbvb_newsletter_list_newsletters() {
	...
	echo do_shortcode('[newsletter_archive]');
//	echo do_shortcode('[newsletter_archive type="automated_X"]');


	if ( ! is_object( $email_newsletter ) ) {
//		echo '<p>' . __( 'Door een programmeerfout is er geen nieuwsbriefarchief beschikbaar.', 'wp-rijkshuisstijl' ) . '</p>';
		return;
	}

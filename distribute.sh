...
sed -i '.bak' 's/Rijkshuisstijl (Digitale Overheid)/2.12.4 - Home zichtbaar voor de juiste templates./g' '/shared-paul-files/Webs/ICTU/Gebruiker Centraal/development/wp-content/themes/wp-rijkshuisstijl-versie-2.12.4/style.css'

...
define( 'CHILD_THEME_VERSION',              "2.12.6" );
define( 'CHILD_THEME_VERSION_DESCRIPTION',  "CSS bugfiks voor 'widget_rhswp_navigationmenu_widget', rhswp_pagelinks_widget geheractiveerd." );

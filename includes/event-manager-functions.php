...
function gc_wbvb_authorbox_compose_box( $userid, $gravatar = '', $sectiontype = '' ) {
  ...
  $output = '<div class="wrap contains-author-box">' . $sectiondiv . '<div class="bg-color">' . $imagetag . '
    <div class="author-info"><' . $header_tag . ' class="author-box-title"><span class="visuallyhidden">' . $prefix . ' </span><span itemprop="name">' .$gebruikersnaam . '</span></' . $header_tag . '>' . $functiebeschrijving . '<hr>' . $biografie . '
      <p>' . $dl;
  if ( !is_author() ) {

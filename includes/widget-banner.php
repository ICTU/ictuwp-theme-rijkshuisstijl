...
class rhswp_banner_widget extends WP_Widget {
	...
	function form($instance) {
		...
		<p><label for="<?php echo $this->get_field_id('rhswp_banner_widget-title'); ?>">Titel: <input id="<?php echo $this->get_field_id('rhswp_banner_widget-title'); ?>" name="<?php echo $this->get_field_name('rhswp_banner_widget_title'); ?>" type="text" value="<?php echo esc_attr($rhswp_banner_widget_title); ?>" /></label></p>
...
/**
 * Adds AAA_PVB_Widget widget.
 */
class AAA_PVB_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'AAA_PVB_Widget', // Base ID
			esc_html__( 'AAA PVB Widget Title', 'text_domain' ), // Name
			array( 'description' => esc_html__( 'AAA PVB Widget description', 'text_domain' ), ) // Args
		);
	}
...
} // class AAA_PVB_Widget

//========================================================================================================

// register AAA_PVB_Widget widget
function register_AAA_PVB_Widget() {
    register_widget( 'AAA_PVB_Widget' );
}

add_action( 'widgets_init', 'register_AAA_PVB_Widget' );	
